      ...
      <div className="w-full py-4 md:py-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 md:gap-4">
          ...
          <Link
            ...
            className="bg-white text-black hover:bg-white/90 font-medium px-3 md:px-6 py-2 md:py-3 rounded-full text-xs md:text-base transition-colors flex items-center gap-1.5"
          >
